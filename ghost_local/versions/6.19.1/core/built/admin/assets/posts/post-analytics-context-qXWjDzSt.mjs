import { E as w, D as N, c as B, u as O, j as R } from "./index-BiGQFQkQ.mjs";
import { a as c } from "./hooks-DQYjPsLg.mjs";
import { u as U } from "./posts-C2SKGLoU.mjs";
...
const Q = (t = {}) => {
  ...
  }), g = [o, e, r], P = g.map((l) => l.error).find(Boolean), k = d ? u.error : null, T = P || k, E = g.some((l) => l.isLoading), I = d ? u.isLoading : !1, D = E || I;
  if (T)
    throw T;
...
//# sourceMappingURL=post-analytics-context-qXWjDzSt.mjs.map
