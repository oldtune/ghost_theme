import { c as J, d as V, a as g, j as e, f as T, e as y, g as ie, h as le, i as ne, k as q, s as ce, b as oe } from "./index-BiGQFQkQ.mjs";
import { u as de, c as me, D as he } from "./growth-DUnL-W24.mjs";
import { K as R, a as I, b as D, c as S } from "./stats-BRVHejqx.mjs";
import { B as z, H as X } from "./heading-DZWin3nG.mjs";
import { C as E, a as $, b as M, M as xe, c as C, K as A, d as K, e as O, G as U, u as Q, h as ue, i as pe, P as je, f as fe, S as ge } from "./post-analytics-header-QGsYyvhA.mjs";
import { D as ve, a as be, b as Ne, c as ye, d as we, e as ke, f as Ce, g as Le } from "./tabs-RcpmzDgr.mjs";
import { B as W } from "./loading-indicator-CZQmPRvv.mjs";
import { S as P } from "./separator-CJnnsW1a.mjs";
import { u as _e, p as Te, N as Re, c as Ie } from "./links-D3nSZFlJ.mjs";
import { L as De } from "./post-share-modal-B9Q7FJsH.mjs";
import { G as Se, S as Ae, K as Ke } from "./kpis-DNnkyd0U.mjs";
import { E as Oe } from "./empty-indicator-CY1NEQZt.mjs";
import { u as Z, S as Pe } from "./post-analytics-context-qXWjDzSt.mjs";
import { S as Y } from "./skeleton-BlZGKNzB.mjs";
const Ve = ({ post: d, isNewsletterStatsLoading: n, isWebShown: u }) => {
    ...
    n ? /* @__PURE__ */ e.jsx(C, { children: /* @__PURE__ */ e.jsx("div", { className: "mx-auto flex min-h-[250px] items-center justify-center xl:size-full", children: /* @__PURE__ */ e.jsx(W, {}) }) }) : /* @__PURE__ */ e.jsxs(C, { className: `${c && "grid grid-cols-2"}`, children: [
      ...
      /* @__PURE__ */ e.jsxs("div", { className: `${c && "pl-6"}`, children: [
        ...
        /* @__PURE__ */ e.jsxs("div", { className: c ? "" : "pt-3", children: [
          ...
          p.length > 0 ? /* @__PURE__ */ e.jsx(ve, { className: "", children: /* @__PURE__ */ e.jsx(be, { children: p.slice(0, c ? 10 : 5).map((o) => {
            const i = r.clicked > 0 ? o.count / r.clicked : 0;
            return /* @__PURE__ */ e.jsxs(Ne, { children: [
              /* @__PURE__ */ e.jsx(ye, { style: {
                width: `${i ? Math.round(i * 100) : 0}%`
              } }),
              /* @__PURE__ */ e.jsx(we, { children: /* @__PURE__ */ e.jsxs("div", { className: "flex items-center space-x-2 overflow-hidden", children: [
                ...
                /* @__PURE__ */ e.jsx(
                  "a",
                  {
                    ...
                    target: "_blank",
                    title: o.link.to,
                    children: Ie(o.link.to, !0)
                  }
                )
              ] }) }),
              /* @__PURE__ */ e.jsxs(ke, { children: [
                /* @__PURE__ */ e.jsx(Ce, { children: y(o.count || 0) }),
                /* @__PURE__ */ e.jsx(Le, { children: T(i) })
              ] })
            ] }, o.link.link_id);
  ...
  const d = V(), { statsConfig: n, isLoading: u, post: s, isPostLoading: t, postId: r } = Z(), { totals: l, isLoading: p, currencySymbol: m } = de(r), { appSettings: a } = ie(), { emailTrackClicks: c, emailTrackOpens: o } = (a == null ? void 0 : a.analytics) || {}, i = g(() => s != null && s.published_at ? le(s.published_at) : Pe.ALL_TIME.value, [s == null ? void 0 : s.published_at]), { startDate: x, endDate: v, timezone: b } = ne(i), N = g(() => {
    ...
    statsConfig: n || { id: "" },
    params: N
  }), B = u || p || t || G, re = t || u || G, L = ue(s) && o && c, _ = !(s != null && s.email_only) && (a == null ? void 0 : a.analytics.webAnalytics), k = a == null ? void 0 : a.analytics.membersTrackSources;
  return oe(() => {
    !t && s && pe(s) && !(a != null && a.analytics.webAnalytics) && k && d(`/posts/analytics/${r}/growth`, { replace: !0 });
  }, [t, s, a == null ? void 0 : a.analytics.webAnalytics, d, r, k]), t ? /* @__PURE__ */ e.jsx(W, {}) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    /* @__PURE__ */ e.jsx(je, { currentTab: "Overview" }),
    /* @__PURE__ */ e.jsx(fe, { children: /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col gap-6 lg:grid lg:grid-cols-2", children: [
      _ && /* @__PURE__ */ e.jsx(
        ze,
        {
          chartData: se,
...
//# sourceMappingURL=overview-C5mCMPJY.mjs.map
